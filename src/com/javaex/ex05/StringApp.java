...
public class StringApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(s01 == s02);	//주소는 다르다
		...
		System.out.println(s03);
		System.out.println(s04);	//같은 주소를 가지고 있어서 같이 바뀔 줄 알았는데 결과 값이 바뀌지 않음
		
		System.out.println(s03.hashCode());	//hashCode() 값이 달라짐
		System.out.println(s04.hashCode());	//hashCode() 값이 변하지 않음
		//수정하게 되면 새로 만들어버림
	}
